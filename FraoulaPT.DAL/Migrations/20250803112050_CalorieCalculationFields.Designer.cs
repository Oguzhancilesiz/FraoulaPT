...
namespace FraoulaPT.DAL.Migrations
{
    ...
    [Migration("20250803112050_CalorieCalculationFields")]
    partial class CalorieCalculationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FraoulaPT.Entity.ExtraPackageUsage", b =>
                {
                    ...
                    b.Property<Guid>("ExtraPackageOptionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExtraPackageOptionId");
            ...
            modelBuilder.Entity("FraoulaPT.Entity.Media", b =>
                {
                    ...
                    b.Property<Guid?>("UserWeeklyFormId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FraoulaPT.Entity.WorkoutExercise", b =>
                {
                    ...
                    b.Property<int?>("RestDurationInSeconds")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraoulaPT.Entity.Exercise", b =>
                {
                    b.HasOne("FraoulaPT.Entity.ExerciseCategory", "Category")
                        .WithMany("Exercises")
            ...
            modelBuilder.Entity("FraoulaPT.Entity.ExtraPackageUsage", b =>
                {
                    b.HasOne("FraoulaPT.Entity.ExtraPackageOption", "ExtraPackageOption")
                        .WithMany("Usages")
                        .HasForeignKey("ExtraPackageOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ExtraPackageOption");
            ...
            modelBuilder.Entity("FraoulaPT.Entity.Media", b =>
                {
                    b.HasOne("FraoulaPT.Entity.UserWeeklyForm", "UserWeeklyForm")
                        .WithMany("ProgressPhotos")
                        .HasForeignKey("UserWeeklyFormId");
            ...
            modelBuilder.Entity("FraoulaPT.Entity.WorkoutExercise", b =>
                {
                    b.HasOne("FraoulaPT.Entity.Exercise", "Exercise")
            ...
            modelBuilder.Entity("FraoulaPT.Entity.WorkoutFeedback", b =>
                {
                    ...
                    b.HasOne("FraoulaPT.Entity.WorkoutExercise", "WorkoutExercise")
                        .WithMany()
            ...
            modelBuilder.Entity("FraoulaPT.Entity.WorkoutProgram", b =>
                {
                    ...
                    b.HasOne("FraoulaPT.Entity.UserWeeklyForm", "UserWeeklyForm")
                        ...
                        .HasForeignKey("FraoulaPT.Entity.WorkoutProgram", "UserWeeklyFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
